...
namespace ConfigurO
{
    ...
    {
        internal readonly static string CoreFolder = CleanHelper.ProgramData + "\\ConfigurO\\";
        internal readonly static string ReadyMadeMenusFolder = CleanHelper.ProgramData + "\\ConfigurO\\ReadyMadeMenus\\";
        internal readonly static string ScriptsFolder = CleanHelper.ProgramData + "\\ConfigurO\\Required\\";
        internal readonly static string ExtractedIconsFolder = CleanHelper.ProgramData + "\\ConfigurO\\ExtractedIcons\\";
        internal readonly static string FavIconsFolder = CleanHelper.ProgramData + "\\ConfigurO\\FavIcons\\";
        internal readonly static string StartupItemsBackupFolder = CleanHelper.ProgramData + "\\ConfigurO\\StartupBackup\\";
