...
namespace ConfigurO
{
    internal static class SilentOps
    {
        ...
        internal static void ProcessAllActions()
        {
            ...
            // Tweaks introduced with the Nocturne redesign are described by
            // TweakRegistry rather than hand-written here.
            TweakRunner.ApplySilent(CurrentSilentConfig.Tweaks);
