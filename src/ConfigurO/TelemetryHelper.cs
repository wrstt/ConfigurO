...
//        internal const string TELEMETRY_KEY = @"{CONFIGURO-0EFC7B8A-D1FC-467F-B4B1-0117C643FE19-TELEMETRY}";
...
//            TelemetryClient.DefaultRequestHeaders.Add("ConfigurOtelemetrykey", TELEMETRY_KEY);
...
//            telemetryEntry.ConfigurOVersion = Program.GetCurrentVersionTostring();
